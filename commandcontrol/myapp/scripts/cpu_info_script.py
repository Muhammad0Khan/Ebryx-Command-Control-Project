...
] = "/Users/stormboi/Downloads/Ebryx-Command-Control-Project-main/commandcontrol/firebase/command-and-control-9c601-firebase-adminsdk-zqbso-ec1942a09a.json"
...
server_url = "https://4b14-110-93-193-114.ngrok-free.app/remote_cpu_info_api/"
...
def save_cpu_info_to_firebase_and_server():
    try:
        while True:
            ...
            firebase_ref = db.reference("cpu_info")
            firebase_ref.push(
                {
                    "Timestamp": timestamp,
                    "CPU Count": cpu_count,
